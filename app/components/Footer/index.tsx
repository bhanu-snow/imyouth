...
const products: ProductType[] = [
    ...
    },
    {
        id: 2,
        section: "Category",
        link: ['Politics', 'Reservation', 'Secularism', 'Unity']
    },
    {
        id: 3,
        section: "Uttar Pradesh",
        link: ['404', 'Meerut', 'Firozabad','Kanpur','Saharanpur']
    },
    {
        id: 4,
        section: "Others",
...
const footer = () => {
    return (
        <div className="bg-iuml-green -mt-40" id="first-section">
            <div className="mx-auto max-w-2xl pt-48 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
                    ...
                    <div className='col-span-4'>
                        <h3 className='text-white text-4xl font-semibold leading-9 mb-4 lg:mb-20'> Muslim Youth League (U.P.)</h3>
            ...
            <div className="bg-iuml-blue mx-auto max-w-2xl lg:max-w-7xl">
                <div className="pt-5 pb-5 px-4 sm:px-6 lg:px-4 border-solid border-t border-footer">
                    <div className="mt-4 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 xl:gap-x-8">
                        <div>
                            <h3 className='text-center md:text-start text-offwhite text-lg'>@2026 - Developed by <Link href="https://codesquare.co.in/" target="_blank"> Code Square Technologies</Link></h3>
                        </div>
